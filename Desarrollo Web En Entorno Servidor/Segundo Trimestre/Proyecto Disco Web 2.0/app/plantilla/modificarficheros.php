		...
		<form name='modificar' method="POST" action="index.php?orden=Modificar">
			...
			<div class="select-div">
				...
				<div class="select-div-right">
					<input type='hidden' value='Modificar' class="modify-user-modify">
				</div>

				<input type='button' name="orden" value='Volver' onclick="verArchivos()" class="modify-user-return">
...
<script type="text/javascript">
	...
	function verArchivos() {
    	document.location.href = "?orden=verArchivos";
	}
